...
# ── 导入 TrinityGuard 组件 ──────────────────────────────────
try:
    from level1_framework.tools.mcp import MCPConnector, attach_mcp_tools
    from level1_framework.ag2_wrapper import create_ag2_mas_from_config
    from level2_intermediary.ag2_intermediary import AG2Intermediary
    from level3_safety.risk_tests.l1_mcp_file_safety import MCPFileSafetyTest
    from level3_safety.risk_tests.l1_mcp_db_safety import MCPDbSafetyTest
    from level3_safety.monitor_agents.mcp_tool_call_monitor import MCPToolCallMonitor
...
def file_intermediary(filesystem_connector, mcp_monitor):
    ...
    from level1_framework.tools.mcp.registry import register_audit_callback
